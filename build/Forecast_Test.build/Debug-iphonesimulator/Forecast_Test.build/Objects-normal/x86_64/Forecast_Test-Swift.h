...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Forecast_Test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13Forecast_Test11AppDelegate")
...
SWIFT_CLASS("_TtC13Forecast_Test17CityTableViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified maxMinTempLabel;
...
SWIFT_CLASS("_TtC13Forecast_Test21ForecastTableViewCell")
@interface ForecastTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified firstIcon;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified firstLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified secondIcon;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified secondLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified thirdIcon;
...
SWIFT_CLASS("_TtC13Forecast_Test18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(Forecast_Test)) <UISearchBarDelegate>
- (void)searchBarSearchButtonClicked:(UISearchBar * _Nonnull)searchBar;
@end


@interface HomeViewController (SWIFT_EXTENSION(Forecast_Test)) <UITableViewDelegate>
- (CGFloat)tableView:(UITableView * _Nonnull)tableView heightForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface HomeViewController (SWIFT_EXTENSION(Forecast_Test)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC13Forecast_Test23NewsHeaderTableViewCell")
...
SWIFT_CLASS("_TtC13Forecast_Test17NewsTableViewCell")
...
SWIFT_CLASS("_TtC13Forecast_Test13SceneDelegate")
